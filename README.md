...
1.  **Hands-Free Control (Live API):** I implemented `gemini-2.5-flash-native-audio-preview-12-25` via WebSockets. The model listens to the microphone and uses **Function Calling** (`takePhoto`, `changeVibe`) to trigger the camera shutter and control the React state in real-time.
...
*   **AI Models:** 
    *   `gemini-2.5-flash-native-audio-preview-12-25` (Live Voice Control)
